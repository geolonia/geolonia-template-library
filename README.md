...
├── docs/                       # ドキュメント
│   ├── 01_contract/            #   仕様書・提案書・業務計画書等
│   ├── 02_estimate/            #   見積もり（工数・費用）
│   ├── 03_work/                #   作業ディレクトリ（設計書・技術検証・調査）
│   ├── 04_meetings/            #   打合せ資料・議事録
│   ├── 05_reference/           #   貸与資料（発注者提供資料）
│   ├── 06_deliverables/        #   納品物（成果品とりまとめ）
│   ├── decisions/              #   ADR (Architecture Decision Records)
│   ├── skills/                 #   スキルの使い方ドキュメント
│   └── templates/              #   テンプレート（議事録・報告書等）
